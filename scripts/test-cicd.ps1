...
try {
    ...
    Write-Host "❌ Error: develop branch doesn't exist. Creating it..." -ForegroundColor Red
...
# Commit change
Write-Host "💾 Committing test change..." -ForegroundColor Cyan
git add README.md
...
Write-Host ""
Write-Host "✅ Test branch created and pushed!" -ForegroundColor Green
Write-Host ""
Write-Host "====================================" -ForegroundColor Green
...
Write-Host "   https://github.com/yellowflowersorganics-star/smartcrop-os" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "4. Select:"
Write-Host "   Base: develop ← Compare: $testBranch" -ForegroundColor Yellow
Write-Host ""
Write-Host "5. Click 'Create pull request'"
Write-Host ""
Write-Host "6. Watch the Actions tab to see CI/CD run:"
Write-Host "   https://github.com/yellowflowersorganics-star/smartcrop-os/actions" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "💡 Tip: If all checks are green, your CI/CD is working!" -ForegroundColor Yellow
Write-Host ""

# Check if GitHub CLI is available
if (Get-Command gh -ErrorAction SilentlyContinue) {
    Write-Host "🤖 GitHub CLI detected!" -ForegroundColor Yellow
    ...
    if ($response -eq 'y' -or $response -eq 'Y') {
        ...
        $prBody = @"
This is an automated test PR to verify the GitHub Actions CI/CD pipeline is working correctly.
...
Write-Host ""
Write-Host "🎉 CI/CD test setup complete!" -ForegroundColor Green
