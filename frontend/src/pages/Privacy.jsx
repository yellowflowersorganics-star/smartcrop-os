        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 space-y-8">
          ...
          <section>
            <p className="text-gray-700 leading-relaxed">
              At SmartCrop OS, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our IoT agriculture platform and services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              SmartCrop OS is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. 
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              Continued use of SmartCrop OS after changes constitutes acceptance of the updated policy.
            </p>
          </section>
          ...
          <section className="bg-green-50 rounded-lg p-6">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p><strong>Mail:</strong> SmartCrop OS, Privacy Department, 123 Agriculture Way, Tech Valley, CA 94000, USA</p>
            </div>
          </section>
