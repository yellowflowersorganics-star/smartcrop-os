...
export default function About() {
  ...
  const milestones = [
    { year: '2020', event: 'SmartCrop OS founded by agricultural engineers', icon: Sprout },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            About <span className="text-green-600">SmartCrop OS</span>
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              SmartCrop OS was born in 2020 when co-founders Dr. Sarah Chen and Michael Rodriguez met at 
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              ...
              and building the first version of SmartCrop OS on nights and weekends. Within three months, 
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Today, SmartCrop OS powers over 1,000 farms across 15 countries, from small urban vertical 
