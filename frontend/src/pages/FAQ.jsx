  ...
  const categories = [
    {
      ...
      faqs: [
        {
          question: 'What is SmartCrop OS?',
          answer: 'SmartCrop OS is a comprehensive IoT-powered farm management platform designed specifically for mushroom cultivation and vertical farming. It provides real-time environmental monitoring, batch tracking, harvest recording, inventory management, and profitability analytics - all in one integrated system.'
        },
        {
          question: 'Do I need technical knowledge to use SmartCrop OS?',
          answer: 'No! SmartCrop OS is designed to be user-friendly for farmers of all technical levels. Our intuitive interface requires no coding or technical expertise. We provide step-by-step guides, video tutorials, and 24/7 support to help you get started.'
        },
        {
          question: 'How long does it take to set up?',
          answer: 'You can create an account and start using SmartCrop OS immediately. For IoT sensor integration, setup typically takes 1-2 hours per zone, depending on your farm size. Our quick-start guide walks you through the entire process, and our support team is available to assist.'
        },
        {
          question: 'Can I import my existing farm data?',
          answer: 'Yes! SmartCrop OS supports CSV imports for farms, zones, inventory items, and historical data. We also offer a data migration service for enterprise customers transitioning from other systems.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          question: 'What sensors does SmartCrop OS support?',
          answer: 'SmartCrop OS works with ESP32-based sensors for temperature, humidity, CO2, light intensity, soil moisture, and pH. We provide detailed wiring guides for DHT22, BH1750, MQ-135, and other common sensors. Our MQTT-based architecture also supports custom sensor integrations.'
        },
        {
        ...
        {
          question: 'How do sensors connect to SmartCrop OS?',
          answer: 'Sensors connect via WiFi to a local MQTT broker (like Mosquitto on a Raspberry Pi), which then forwards data to SmartCrop OS via our REST API. This architecture works on-premise or in the cloud, ensuring your data stays secure and operations continue even during internet outages.'
        },
        {
          question: 'What if I don\'t have IoT sensors yet?',
          answer: 'You can still use SmartCrop OS! All features work with manual data entry. The platform provides simulated environmental data for testing. You can add IoT sensors later at your own pace - the system is designed to grow with your operation.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          question: 'How much does SmartCrop OS cost?',
    ...
    },
    {
      ...
      faqs: [
        {
          question: 'What features does SmartCrop OS include?',
          answer: 'SmartCrop OS includes: Farm & Zone Management, Growing Recipes, Batch Tracking, Harvest Recording, Real-time Environmental Monitoring, Alerts & Notifications, Inventory Management, Task Management, Labor Tracking, Cost & Revenue Tracking, Profitability Analytics, Quality Control, SOP Management, and comprehensive Analytics & Reporting.'
        },
        {
          question: 'Can I manage multiple farms?',
          answer: 'Yes! SmartCrop OS is designed for multi-farm operations. You can manage unlimited farms (depending on your plan), each with multiple zones, different crop recipes, and separate teams. The dashboard provides a consolidated view across all your operations.'
        },
        {
          question: 'Does it work for crops other than mushrooms?',
          answer: 'While SmartCrop OS was originally designed for mushroom cultivation, it works for any crop that requires environmental monitoring and stage-based growing protocols. Many customers use it for leafy greens, herbs, microgreens, and other specialty crops in vertical farms.'
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'Only authorized users on your account can access your data. You control user permissions with role-based access control (RBAC). SmartCrop OS staff never access your data without explicit permission, and then only to provide technical support or resolve specific issues.'
        },
        {
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Find answers to common questions about SmartCrop OS. Can't find what you're looking for? 
