...
// Oyster Mushroom Template
const OYSTER_MUSHROOM_TEMPLATE = {
  ...
  tags: ['mushroom', 'oyster', 'beginner-friendly', 'high-yield', 'fast-growing']
};
...
export default function CropRecipes() {
  ...
  const createFromTemplate = async () => {
    try {
      await api.post('/crop-recipes', OYSTER_MUSHROOM_TEMPLATE);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-900">Oyster Mushroom Recipe</h2>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 mb-2">🍄 {OYSTER_MUSHROOM_TEMPLATE.cropName}</h3>
                <p className="text-sm text-gray-700">{OYSTER_MUSHROOM_TEMPLATE.description}</p>
                <div className="mt-4 grid grid-cols-3 gap-4">
                  <div>
                    <p className="text-xs text-gray-600">Duration</p>
                    <p className="text-lg font-bold text-blue-600">{OYSTER_MUSHROOM_TEMPLATE.totalDuration} days</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-600">Stages</p>
                    <p className="text-lg font-bold text-blue-600">{OYSTER_MUSHROOM_TEMPLATE.stages.length}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-600">Difficulty</p>
                    <p className="text-lg font-bold text-green-600 capitalize">{OYSTER_MUSHROOM_TEMPLATE.difficulty}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {OYSTER_MUSHROOM_TEMPLATE.stages.map((stage, index) => (
              ...
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-bold text-green-600">{OYSTER_MUSHROOM_TEMPLATE.estimatedYield.totalKg} kg</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-600">Flushes</p>
                    <p className="text-lg font-bold text-green-600">{OYSTER_MUSHROOM_TEMPLATE.estimatedYield.flushes}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-600">Bio Efficiency</p>
                    <p className="text-lg font-bold text-green-600">{OYSTER_MUSHROOM_TEMPLATE.estimatedYield.bioEfficiency}%</p>
                  </div>
                </div>
              </div>
            </div>
